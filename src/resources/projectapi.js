...
class ProjectApi {
  ...
  static getMaxProjects(count, onlyFeatured, hideFeatured) {
    return new Promise((resolve, reject) => {
      const url =
        `${OriginApiUrl}/api/projects/max?amount=${count}` +
    ...
    return new Promise((resolve, reject) => {
      ...
      if (settings) {
        ...
        if (settings.featured) {
          urlSections.push(
            `&featured=${encodeURIComponent(settings.featured)}`,
          );
        }
        if (settings.sortby) {
  ...
  reportContent(type, nameOrId, reason) {
    ...
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/${type}s/report?username=${this.username}&passcode=${this.privateCode}&target=${nameOrId}&reason=${reason}`,
      )
        .then((res) => {
          res
            .json()
  ...
  assingUsersPermisions(username, admin, approver) {
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/users/assignPossition?user=${this.username}&passcode=${this.privateCode}&target=${username}&admin=${admin}&approver=${approver}`,
      )
        .then((res) => {
          res
            .json()
  ...
  setErrorAllGetProjects(enabled) {
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/errorAllProjectRequests?user=${this.username}&passcode=${this.privateCode}&enabled=${enabled}`,
      )
        .then((res) => {
          res
            .json()
  ...
  setErrorAllUploadProjects(enabled) {
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/errorAllProjectUploads?user=${this.username}&passcode=${this.privateCode}&enabled=${enabled}`,
      )
        .then((res) => {
          res
            .json()
  ...
  deleteProject(id) {
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/projects/delete?passcode=${this.privateCode}&approver=${this.username}&id=${id}`,
      )
        .then((res) => {
          res
            .json()
  ...
  setBio(text, adminForced, adminTarget) {
    ...
    return new Promise((resolve, reject) => {
      fetch(
        `${OriginApiUrl}/api/users/${
          adminForced ? "setUserBioAdmin" : "setBio"
        }`,
        {
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
  ...
  updateProject(id, newData) {
    ...
    return new Promise((resolve, reject) => {
      fetch(`${OriginApiUrl}/api/projects/update`, {
        headers: { "Content-Type": "application/json" },
  ...
  uploadProject(data) {
    ...
    return new Promise((resolve, reject) => {
      fetch(`${OriginApiUrl}/api/projects/publish`, {
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(data),
        method: "POST",
      })
