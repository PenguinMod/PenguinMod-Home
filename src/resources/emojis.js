const emojiHtmlUrl =
  "https://corsproxy.io/?https%3A%2F%2Flibrary.penguinmod.com%2Ffiles%2Femojis";
  ...
  static fetch() {
    return new Promise((resolve, reject) => {
      ...
      (async () => {
        ...
        const emojis = htmle
          .substring(
            htmle.indexOf("</header><ul id=files>") + 22,
            htmle.indexOf("</ul></main>"),
          )
          .split("\n")
          .map((line) => line.trim())
