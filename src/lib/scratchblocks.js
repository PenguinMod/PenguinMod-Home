  ...
  (function () {
    ...
    function lookupDropdown(name, languages) {
      ...
      try {
        for (_iterator10.s(); !(_step10 = _iterator10.n()).done; ) {
          ...
          if (
            Object.prototype.hasOwnProperty.call(lang.nativeDropdowns, name)
          ) {
    ...
    var Block = /*#__PURE__*/ (function () {
      function Block(info, children, comment) {
        ...
        this.isHat =
          shape === "hat" || shape === "cat" || shape === "define-hat";
        this.hasPuzzle =
          shape === "stack" ||
          shape === "hat" ||
          shape === "cat" ||
              ...
              .map(function (child) {
                if (child.isInput && child.isBoolean) {
                  ...
                  if (child.info.categoryIsDefault) {
                    ...
                    child.info.argument = child.isBoolean
                      ? "boolean"
                      : "number";
                  }
                }
          ...
          },
          {
            ...
            value: function drawSelf(w, h, lines) {
              ...
              if (this.isRing) {
                ...
                if (
                  child &&
                  (child.isStack || child.isBlock || child.isScript)
                ) {
        ...
        [
          ...
          },
          {
            ...
            value: function draw() {
              ...
              return SVG$1.group([
                SVG$1.commentLine(
                  this.hasBlock ? CommentView.lineLength : 0,
                  6,
                ),
        ...
        },
        {
          ...
          value: function exportSVG() {
            ...
            return (
              ...
              xml.replace(/[#]/g, encodeURIComponent)
            );
          },
        },
        {
          ...
          },
          {
            ...
            value: function drawSelf(iconStyle, w, h, lines) {
              ...
              if (this.isRing) {
                ...
                if (
                  child &&
                  (child.isInput || child.isBlock || child.isScript)
                ) {
